...
Before generating or changing code, read and apply these skills:

- [code-structure](.agents/skills/code-structure/SKILL.md): search first, reuse existing code, and group by responsibility.
- [code-documentation](.agents/skills/code-documentation/SKILL.md): cohesive contextual prose wrapped over 5–9 lines, accurate caller contracts, and single-line type/class field docs.
